...
const ShoppingCart = require("../db_mongo/schema/shoppingCart");
...
// Create a new cart
router.post("/shoppingCart", auth, async (req, res) => {
...
router.get("/shoppingCart/:id", auth, async (req, res) => {
  const { id } = req.params;
  try {
...
router.put("/shoppingCart/updateCart/", auth, async (req, res) => {
...
router.put("/shoppingCart/checkout", auth, async (req, res) => {
...
router.delete("/shoppingCart/:id", auth, async (req, res) => {
  const { id } = req.params;
